...
<head>
  ...
  <?php if(!empty($gmapsKey)): ?>
    <meta name="google-maps-key" content="<?php echo e($gmapsKey); ?>">
  <?php endif; ?>
...
<body>
  <header class="app-header">
    <div class="wrap">
      <a class="brand" href="<?php echo e(route('clientes.index')); ?>">
        <img
          src="<?php echo e(secure_asset('logoN.png')); ?>?v=<?php echo e(file_exists(public_path('logoN.png')) ? filemtime(public_path('logoN.png')) : time()); ?>"
          alt="Renacer"
        />
      </a>
      <nav class="nav">
        <a href="<?php echo e(route('clientes.index')); ?>" class="<?php echo e(request()->routeIs('clientes.index') ? 'active' : ''); ?>">Clientes</a>
        <a href="<?php echo e(route('clientes.form')); ?>" class="<?php echo e(request()->routeIs('clientes.form')  ? 'active' : ''); ?>">Importar</a>
        
        <?php if(\Illuminate\Support\Facades\Route::has('agenda.index')): ?>
          <a href="<?php echo e(route('agenda.index')); ?>" class="<?php echo e(request()->routeIs('agenda.*')  ? 'active' : ''); ?>">Agenda</a>
        <?php else: ?>
          <a href="<?php echo e(url('/agenda')); ?>" class="<?php echo e(request()->is('agenda*') ? 'active' : ''); ?>">Agenda</a>
        <?php endif; ?>

        
        <?php if(\Illuminate\Support\Facades\Route::has('finanzas.index')): ?>
        <a href="<?php echo e(route('finanzas.index')); ?>" class="<?php echo e(request()->routeIs('finanzas.*') ? 'active' : ''); ?>">Finanzas</a>
        <?php endif; ?>
  ...
  <script>
    window.GMAPS_KEY = <?php echo json_encode(config('services.google.maps_browser_key'), 15, 512) ?>;
