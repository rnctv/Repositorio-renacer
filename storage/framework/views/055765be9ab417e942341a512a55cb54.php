...
<div class="container-xxl py-4 up-shell">
  <header class="up-header">
    ...
    <div class="up-badges">
      ...
      <a class="btn-soft" href="<?php echo e(url()->current()); ?>?key=<?php echo e(request('key')); ?>">↻ Refrescar</a>
    </div>
  </header>
                ...
                <li class="d-flex align-items-center justify-content-between gap-3">
                  ...
                  <div class="d-flex gap-2">
                    ...
                    <?php if(Route::has('tools.updater.delete')): ?>
                      <form method="POST" action="<?php echo e(route('tools.updater.delete', $name)); ?>" onsubmit="return confirm('¿Eliminar backup <?php echo e($name); ?>?');">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="key" value="<?php echo e(request('key')); ?>">
